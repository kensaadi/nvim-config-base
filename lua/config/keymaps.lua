...
-- Search task info on JSDOC
vim.keymap.set("n", "<leader>nn", function()
  require("telescope.builtin").live_grep({ default_text = "TODO\\|WIP\\|FIX" })
end, { desc = "🔍 search TODO/WIP/FIX" })

-- Neogen snippets to JSDocs
vim.keymap.set("n", "<leader>dn", ":Neogen<CR>", { noremap = true, silent = true, desc = "Generate JSDoc with Neogen" })
...
-- Prettier
set_keymap("n", "<leader>p", ":!prettier --write %<CR>", { noremap = true, silent = true })
